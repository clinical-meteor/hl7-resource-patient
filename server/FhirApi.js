...
export const FhirApi = {
    ...
    returnPostResponseAfterAccessCheck: function(req, filter, pagination, callback){
      ...
      if (accessToken || this.noAuth || this.disableOauth) {
        ...
        let filter = FhirApi.generateFilter(req);
        let pagination = FhirApi.generatePagination(req);
      
        let dataPayload = callback(filter, pagination);

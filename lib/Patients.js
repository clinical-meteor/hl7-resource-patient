...
PatientSchema = new SimpleSchema({
  ...
  "birthDate" : {
    ...
    type: String,
    autoValue: function() {
      var dateArray = this.field('birthDate').value.split('-')
      this.field('_birthDate').value = new Date(dateArray[0], dateArray[1] - 1, dateArray[2])
    }},
  "_birthDate" : {
      optional: true,
      type: Date
...
export { Patient, Patients, PatientSchema };
